...
public class SettingAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageView = (CircleImageView) findViewById(R.id.setting_profile_img);
        ...
        closeTextBtn = (TextView) findViewById(R.id.toolbarSetting_close);
        saveTextButton = (TextView) findViewById(R.id.toolbarSetting_update);
    ...
    private void updateOnlyUserInfo() {
        ...
        startActivity(new Intent(SettingAcitivity.this, MainActivity.class));
        Toast.makeText(SettingAcitivity.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            startActivity(new Intent(SettingAcitivity.this, SettingAcitivity.class));
            finish();
        }
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(SettingAcitivity.this, HomeActivity.class));
                                Toast.makeText(SettingAcitivity.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(SettingAcitivity.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        } else {
